  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation active:scale-95",
  {
    variants: {
      variant: {
        ...
        corporate: "bg-corporate-blue text-white hover:bg-corporate-blue/90 shadow-sm hover:shadow-md",
        kakao: "bg-kakao-yellow text-kakao-dark hover:bg-kakao-yellow/90 shadow-sm hover:shadow-md font-semibold",
        premium: "bg-gradient-to-r from-kakao-yellow to-accent text-kakao-dark shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 font-semibold",
        glass: "bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 shadow-sm",
      },
      size: {
        default: "h-10 px-4 py-2 min-h-[44px]", // Ensure 44px minimum for mobile
        sm: "h-9 rounded-md px-3 min-h-[40px]",
        lg: "h-11 rounded-md px-8 min-h-[48px]",
        icon: "h-10 w-10 min-h-[44px] min-w-[44px]",
        xs: "h-7 rounded px-2 text-xs min-h-[32px]",
        xl: "h-12 rounded-lg px-10 text-base font-semibold min-h-[48px]",
      },
    },
    defaultVariants: {
      variant: "default",
